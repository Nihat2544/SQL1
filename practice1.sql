...
(                                                                                             
id serial primary key  , --Serial id yi aut incerment gibi otomatik artirir                                                                     
isim varchar(20),                                                                             
yas int,                                                                                      
maas int,                                                                                     
email varchar(30)                                                                             
...
select * from personel where isim ilike  'a%'-- % isareti ne ile devam ederse etsin anlamina giliyor
...
select * from personel order by yas;-- dogal sirilamasi kucukten buyuge asc
